...
import com.library.libraryproject.entity.dto.Room;
...
public class TestFastJson {
    ...
    public void testArea(){
        ...
        Storey storey= Storey.builder().name("一层").id("06").rooms(Lists.newArrayList(Room.builder().id("11").name("11").build())).build();
        Storey storey1= Storey.builder().name("二层").id("07").rooms(Lists.newArrayList(Room.builder().id("11").name("11").build())).build();
